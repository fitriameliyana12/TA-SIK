...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-3 text-gray-800 font-weight-bold">Tambah Data Pasien</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h5 class="font-weight-bold text-primary">Data Pasien
        </h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('admin-pasien.store') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="no_rekam_medis">Nomer Rekam Medis</label>
            <input type="text" class="form-control @error('no_rekam_medis') is-invalid @enderror" id="no_rekam_medis"
              name="no_rekam_medis" placeholder="No Rekam Medis" value="{{ old('no_rekam_medis') }}">
